# Declarations of terms tracked in the *test34* collection
...
You can [explore the tracked versions](https://github.com/Ndpnt/test34-versions) interactively or [download them as a dataset](https://github.com/Ndpnt/test34-versions/releases) in the `Ndpnt/test34-versions` repository.
